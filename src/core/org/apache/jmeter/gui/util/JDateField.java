 ...
 * <p>
 * This will set the date "yyyy/MM/dd HH:mm:ss sss" in this format only.
 * </p>
 */
public class JDateField extends JTextField {
    ...
    private final DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss sss"); // $NON-NLS-1$
